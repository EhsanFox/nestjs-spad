import { Body, Controller, Get, Post, Patch, Req, Res, UseGuards, UseInterceptors, UploadedFile } from '@nestjs/common';
...
export class AuthController
{
    ...
    @Patch('me')
    @UseGuards(AuthGuard)
    public async updateMe(@AccountDecorator() accountId: number, @Body() data: UpdateDto)
    {
